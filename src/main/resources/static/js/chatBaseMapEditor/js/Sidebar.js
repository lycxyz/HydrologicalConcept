 ...
 */
Sidebar.prototype.thumbHeight = 210;
 ...
 */
Sidebar.prototype.defaultImageWidth = 210;

/**
 * Specifies the height for clipart images. Default is 80.
 */
Sidebar.prototype.defaultImageHeight = 210;
    ...
    $.ajax({
      ...
      success: (res) => {
        ...
        for (var i = 0; i < result.length; i++) {
          var concept = result[i];
          var name = concept.name;
          this.createConceptMapTemplateEntry('image;html=1;labelBackgroundColor=#ffffff;image=' + concept.pathUrl,
              210, 210, name, null, null, null, name, concept.conceptId);
...
Sidebar.prototype.createConceptMapTemplateEntry = function (style, width, height, value, title, showLabel, showTitle, tags, conceptId) {
  tags = (tags != null && tags.length > 0) ? tags : title.toLowerCase();

  return this.addEntry(tags, mxUtils.bind(this, function () {
    return this.createConceptMapTemplate(style, width, height, value, title, showLabel, showTitle, true, conceptId);
  }));
}
