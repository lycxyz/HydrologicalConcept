...
var ConceptTasksReadDialog=function(editorUi){
    ...
    head.innerHTML='Load Tasks 1111';
        ...
        $.ajax({
            ...
            success:  (data)=> {
                if(data!==""||data!=="undefined"||data!=null){
                    ...
                    // dataJSON["Description"]=$('#graphDescriptionSave').val();
                    // sessionStorage.setItem("graphDescription",$('#graphDescriptionSave').val());
                    window.taskName=sessionStorage.getItem("graphName");
                    window.taskDescription=sessionStorage.getItem("graphDescription");
					editorUi.hideDialog();
                }
            },
            error: function () {
...
/**
 * Constructs a new chatting dialog
 */
// var ChatDialog = function(editorUi){
//     var div = document.createElement("div");
//     div.style.textAlign = "center";
//     var head = document.createElement('h1');
//     head.innerHTML = "Open chat-dialog";
//     var p = document.createElement("p");
//     p.innerHTML = "chatroom";
//     div.appendChild(head);
//     div.appendChild(p);
//     this.container = div;
// };
