...
// Sidebar.prototype.addChatTool = function(expand){
//   var chatDiv = document.createElement("div");
//   chatDiv.className = "chatDiv";
//   chatDiv.style.cssText="background-color:lightgray;width:208px;height:20px;left:0px;height:auto;min-height:400px;";
//   chatDiv.innerHTML="这里是聊天区域";
...
//   var that = this;
//   $.ajax({
//     // http://geomodeling.njnu.edu.cn/geoIcon/parentList
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateEntry = function (style, width, height, value, title, showLabel, showTitle, tags, iconId) {
    tags = (tags != null && tags.length > 0) ? tags : title.toLowerCase();

    return this.addEntry(tags, mxUtils.bind(this, function () {
        return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle, true, iconId);
    }));
};
